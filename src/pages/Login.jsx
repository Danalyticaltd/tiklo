    ...
    <div className="min-h-screen bg-bg flex flex-col">
      <div className="flex-1 flex flex-col items-center justify-center p-4 gap-4">
        ...
        <div className="w-full max-w-sm bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
          ...
          <h1 className="font-heading text-3xl font-bold text-gray-900 mb-1">{t('login.title')}</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm text-muted mb-1">{t('login.email')}</label>
              <input
            ...
            <div>
              <label className="block text-sm text-muted mb-1">{t('login.password')}</label>
              <input
          ...
          <p className="text-center text-muted text-sm mt-4">
            <Link to={lp('/forgot-password')} className="text-primary hover:underline">{t('login.forgotPassword')}</Link>
          </p>
          <p className="text-center text-muted text-sm mt-3">
            {t('login.noAccount')} <Link to={lp('/register')} className="text-primary hover:underline">{t('login.register')}</Link>
          </p>
        </div>
      </div>
      <Footer />
